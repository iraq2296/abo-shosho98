...
https://telegram.me/joinchat/CgJAOkDLhldXGB60lzf2yw]] end if not is_momod(msg) then return "للمشرفين فقط ⛔️😴✋🏿" end end return { description = "Help list", usage = "Help list", patterns = { "[#!/](he3)" }, run = run } end 
